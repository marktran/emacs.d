...
(defun color-theme-choco ()
  ...
  (color-theme-install
   '(color-theme-choco
     ...
     (gnus-summary-high-unread ((t (:foreground "#cf6a4c"))))
     ...
     (magit-diff-del ((t (:foreground "#cf6a4c"))))
     ...
     (w3m-arrived-anchor ((t (:foreground "#cf6a4c"))))
